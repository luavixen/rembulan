...
import dev.foxgirl.rembulan.compiler.analysis.types.*;
...
//			throw new IllegalStateException(mv + " assigned to more than once");
	...
	private static StaticMathImplementation staticMath(BinOp.Op op) {
		switch (op) {
			case ADD:  return StaticMathImplementation.MAY_BE_INTEGER;
			case SUB:  return StaticMathImplementation.MAY_BE_INTEGER;
			case MUL:  return StaticMathImplementation.MAY_BE_INTEGER;
			case MOD:  return StaticMathImplementation.MAY_BE_INTEGER;
			case POW:  return StaticMathImplementation.MUST_BE_FLOAT;
			case DIV:  return StaticMathImplementation.MUST_BE_FLOAT;
			case IDIV: return StaticMathImplementation.MAY_BE_INTEGER;
			case BAND: return StaticMathImplementation.MUST_BE_INTEGER;
			case BOR:  return StaticMathImplementation.MUST_BE_INTEGER;
			case BXOR: return StaticMathImplementation.MUST_BE_INTEGER;
			case SHL:  return StaticMathImplementation.MUST_BE_INTEGER;
			case SHR:  return StaticMathImplementation.MUST_BE_INTEGER;
			default:   return null;
		}
	}
	...
	public void visit(UnOp node) {
		...
		if (emulatedResult != null) {
			...
			switch (node.op()) {
				case UNM:  result = StaticMathImplementation.MAY_BE_INTEGER.opType(a).toType(); break;
				case BNOT: result = StaticMathImplementation.MUST_BE_INTEGER.opType(a).toType(); break;
